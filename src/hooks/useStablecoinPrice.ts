...
import { CUSD_CELO, DAI_OPTIMISM, USDC_ARBITRUM, USDC_BUILDBEAR, USDC_MAINNET, USDC_POLYGON } from '../constants/tokens'
...
export const STABLECOIN_AMOUNT_OUT: { [chainId: number]: CurrencyAmount<Token> } = {
  ...
  [SupportedChainId.BUILDBEAR]: CurrencyAmount.fromRawAmount(USDC_BUILDBEAR, 10_000e6),
